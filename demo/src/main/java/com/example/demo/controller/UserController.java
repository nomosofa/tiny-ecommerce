...
public class UserController {
    ...
    public ResponseEntity<ApiResponse> updateUser(@PathVariable String username, @RequestBody User user) {
        ApiResponse apiResponse = userService.updateUser(username, user);
        return ResponseEntity.ok(apiResponse);
    }

    @GetMapping("/{username}")
    public ResponseEntity<ApiResponse> getUserDetails(@PathVariable String username) {
        ApiResponse apiResponse = userService.getUserDetails(username);
        return ResponseEntity.ok(apiResponse);
    }
